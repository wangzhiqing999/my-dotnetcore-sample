...
namespace W2001_Mvc_V8.Models
{
    ...
    public class CommonServiceResult<T>
    {
        ...
        /// 最后更新时间不匹配.
        /// </summary>
        public const string ResultCodeIsLastUpdateTimeNotMatch = "COMMON_LAST_UPDATE_TIME_NOT_MATCH";

        public static readonly CommonServiceResult<T> LastUpdateTimeNotMatchResult = new CommonServiceResult<T>()
        {
            ResultCode = ResultCodeIsLastUpdateTimeNotMatch,
            ResultMessage = "最后更新时间不匹配！",
        };
    ...
    public class CommonServiceResult : CommonServiceResult<dynamic> {
        ...
        public new static readonly CommonServiceResult LastUpdateTimeNotMatchResult = new CommonServiceResult()
        {
            ResultCode = ResultCodeIsLastUpdateTimeNotMatch,
            ResultMessage = "最后更新时间不匹配！",
        };
