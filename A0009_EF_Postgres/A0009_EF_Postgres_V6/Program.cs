...
using A0009_EF_Postgres_V6.Model;
using A0009_EF_Postgres_V6.DataAccess;


namespace A0009_EF_Postgres_V6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql(@"Server=192.168.1.153;Port=5432;User ID=postgres;Password=123456;Database=postgres;");
