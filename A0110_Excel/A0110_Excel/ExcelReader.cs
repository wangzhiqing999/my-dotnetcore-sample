...
namespace A0110_Excel
{
    internal class ExcelReader
    {
        ...
        /// <returns></returns>
        public List<string> GetSheetNames(string excelFileName)
        {
            ...
            using (FileStream fs = File.OpenRead(excelFileName))
            {
                ...
                if (workbook != null)
                {
                    ...
                    for (int sheetIndex = 0; sheetIndex < workbook.NumberOfSheets; sheetIndex++)
                    {
                        ...
                        if (sheet != null)
                        {
                            resultList.Add(sheet.SheetName);
                        }
                    }
                }
            }
        ...
        /// <param name="excelFileName"></param>
        /// <returns></returns>
        public List<ExcelSheetInfo> GetSheetInfo(string excelFileName)
        {
        ...
        /// <returns></returns>
        public List<string> GetSheetDataColumns(string excelFileName, string sheetName, int startRow = 0, bool hasTitle = true)
        {
            List<string> resultList = new List<string>();
                        ...
                        for (int i = firstRow.FirstCellNum; i < cellCount; ++i)
                        {
                            ...
                            if (cell != null)
                            {
                                if (hasTitle)
                                {
                                    ...
                                    if (cell.StringCellValue != null)
                                    {
                                        resultList.Add(cell.StringCellValue);
                                    }
                                } 
                                else
                                {
        ...
        /// <param name="hasTitle">是否首行是标题行，默认值为 true</param>
        /// <returns></returns>
        public IEnumerable<Dictionary<string, object>> GetSheetData(string excelFileName, string sheetName, int startRow = 0, bool hasTitle = true)
        {
