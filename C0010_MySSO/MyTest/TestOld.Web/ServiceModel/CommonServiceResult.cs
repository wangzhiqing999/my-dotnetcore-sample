...
namespace TestOld.Web.ServiceModel
{
    ...
    {
        public CommonServiceResult() : base()
        {
        }

        public CommonServiceResult(Exception ex) : base(ex)
        {
        }
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public new static CommonServiceResult CreateFailResult(string code, string message)
        {
            CommonServiceResult result = new CommonServiceResult()
            {
                ResultCode = code,
